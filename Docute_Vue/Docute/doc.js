(function(t, e) {
    ...
    return function(t) {
        ...
        function l(t, e, n) {
            ...
            j.config.silent = !0, t._vm = new j({
                ...
                computed: a
            }), j.config.silent = s, t.strict && g(t), r && (n && t._withCommit(function() {
                r._data.$$state = null
            }), j.nextTick(function() {
                return r.$destroy()
            }))
        ...
        }, Object.defineProperties(E.prototype, T), "undefined" != typeof window && window.Vue && _(window.Vue);
        ...
        e.a = {
            ...
            data: function() {
                return {
                    components: r.b.components[this.place],
        ...
        function s(t) {
            return !(/^https?:\/\//.test(t) && !new RegExp("^" + location.origin).test(t)) && "include"
        }
        e.d = o, e.c = i, e.b = a, e.a = s
    }, function(t, e, n) {
        "use strict";
        ...
        function p(t, e, n) {
            if (n || "function" == typeof e) {
                ...
                for (; c < o.length; c++)(function(t) {
                    "code" !== t.type ? --i || l() : u(t.text, t.lang, function(e, n) {
        ...
        v.checkbox = /^\[([ x])\] +/, v.bullet = /(?:[*+-]|\d+\.)/, v.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, v.item = c(v.item, "gm")(/bull/g, v.bullet)(), v.list = c(v.list)(/bull/g, v.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + v.def.source + ")")(), v.blockquote = c(v.blockquote)("def", v.def)(), v._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", v.html = c(v.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, v._tag)(), v.paragraph = c(v.paragraph)("hr", v.hr)("heading", v.heading)("lheading", v.lheading)("blockquote", v.blockquote)("tag", "<" + v._tag)("def", v.def)(), v.normal = f({}, v), v.gfm = f({}, v.normal, {
            ...
            paragraph: /^/,
            heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/
        }), v.gfm.paragraph = c(v.paragraph)("(?!", "(?!" + v.gfm.fences.source.replace("\\1", "\\2") + "|" + v.list.source.replace("\\1", "\\3") + "|")(), v.tables = f({}, v.gfm, {
            nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
            table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
            ...
            for (var r, o, i, a, s, u, c, l, f, p, t = t.replace(/^ +$/gm, ""); t;)
                ...
                for (t = t.substring(i[0].length), u = {
                        type: "table",
            ...
            }), i = i[0].replace(/^ *> ?/gm, ""), this.token(i, e, !0), this.tokens.push({
                type: "blockquote_end"
            });
        ...
        m._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, m._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, m.link = c(m.link)("inside", m._inside)("href", m._href)(), m.reflink = c(m.reflink)("inside", m._inside)(), m.normal = f({}, m), m.pedantic = f({}, m.normal, {
            ...
            for (var e, n, r, o, i = ""; t;)
                ...
                else if (o = this.rules.link.exec(t)) t = t.substring(o[0].length), this.inLink = !0, i += this.outputLink(o, {
                    href: o[2],
                    title: o[3]
                }), this.inLink = !1;
                ...
                } else if (o = this.rules.strong.exec(t)) t = t.substring(o[0].length), i += this.renderer.strong(this.output(o[2] || o[1]));
            ...
            return "<del>" + t + "</del>"
        }, i.prototype.link = function(t, e, r) {
            if (this.options.sanitize) {
                try {
                    var o = decodeURIComponent(u(t)).replace(/[^\w:]/g, "").toLowerCase()
                } catch (t) {
                    return ""
                }
            ...
            var p = '<a href="' + t + '"';
            return e && (p += ' title="' + e + '"'), a && (p += " " + a + '="' + i + '"'), this.options.targetBlank && !a && (p += ' target="_blank"'), p += ">" + r + "</a>"
        ...
        (function(i, a) {
            ...
            u.configure = function(t) {
                ...
                function() {
                    ...
                    }), c.showSpinner || (r = n.querySelector(c.spinnerSelector)) && s(r), l != document.body && o(l, "nprogress-custom-parent"), l.appendChild(n), n
                }, u.remove = function() {
        ...
        (function(t) {
            ...
            function j(t) {
                fi.target && pi.push(fi.target), fi.target = t
            }
            ...
            function N(t, e, n, r) {
                ...
                if (!i || !1 !== i.configurable) {
                    ...
                    Object.defineProperty(t, e, {
                        ...
                        get: function() {
                            var e = a ? a.call(t) : n;
                            return fi.target && (o.depend(), u && u.dep.depend(), Array.isArray(e) && R(e)), e
                        },
                        set: function(e) {
                            var r = a ? a.call(t) : n;
            ...
            function B(t, e, n) {
                ...
                "function" == typeof e && (e = e.options), U(e), H(e);
                var o = e.extends;
            ...
            function V(t, e, n, r) {
                var o = e[t],
                    i = !h(n, t),
                    a = n[t];
                if (K(Boolean, o.type) && (i && !h(o, "default") ? a = !1 : K(String, o.type) || "" !== a && a !== Ro(t) || (a = !0)), void 0 === a) {
                    a = W(r, o, t);
            ...
            function yt(t, e, n) {
                t.$el = e, t.$options.render || (t.$options.render = ki), kt(t, "beforeMount");
                var r;
                return r = function() {
                    t._update(t._render(), n)
                }, t._watcher = new Li(t, r, _), n = !1, null == t.$vnode && (t._isMounted = !0, kt(t, "mounted")), t
            }
            ...
            function $t() {
                Ti = Oi.length = Si.length = 0, Ai = {}, ji = Ei = !1
            }
            ...
            function Ct() {
                ...
                for (Oi.sort(function(t, e) {
                        return t.id - e.id
                    }), Ti = 0; Ti < Oi.length; Ti++) t = Oi[Ti], e = t.id, Ai[e] = null, t.run();
                var n = Si.slice(),
                    r = Oi.slice();
            ...
            function Dt(t, e, n) {
                "function" == typeof n ? (Ii.get = qt(e), Ii.set = _) : (Ii.get = n.get ? !1 !== n.cache ? qt(e) : n.get : _, Ii.set = n.set ? n.set : _), Object.defineProperty(t, e, Ii)
            }
            ...
            function Wt(t, e, n, o, i) {
                ...
                var c = Object.create(o),
                    ...
                    f = t.options.render.call(null, l, {
                        ...
                        parent: o,
                        listeners: n.on || {},
                        injections: Vt(t.options.inject, o),
                        slots: function() {
                            return ht(i, o)
                        }
                    });
            ...
            function Kt(t, e, i, a, u) {
                if (!n(t)) {
                    ...
                    if (s(t) && (t = c.extend(t)), "function" == typeof t && (!n(t.cid) || void 0 !== (t = ut(t, c, i)))) {
                        de(t), e = e || {}, r(e.model) && Xt(t.options, e);
                        var l = et(e, t, u);
            ...
            function te(t, e, n, o, i) {
                ...
                Array.isArray(o) && "function" == typeof o[0] && (n = n || {}, n.scopedSlots = {
                    default: o[0]
                }, o.length = 0), i === Fi ? o = ot(o) : i === qi && (o = rt(o));
                var a, s;
                if ("string" == typeof e) {
                    var u;
                    s = Bo.getTagNamespace(e), a = Bo.isReservedTag(e) ? new _i(Bo.parsePlatformTagName(e), n, o, void 0, void 0, t) : r(u = z(t.$options, "components", e)) ? Kt(u, n, t, o, e) : new _i(e, n, o, void 0, void 0, t)
                } else a = Kt(e, n, t, o);
            ...
            function be(t) {
                ...
                t.extend = function(t) {
                    ...
                    return a.prototype = Object.create(n.prototype), a.prototype.constructor = a, a.cid = e++, a.options = B(n.options, t), a.super = n, a.options.props && _e(a), a.options.computed && we(a), a.extend = n.extend, a.mixin = n.mixin, a.use = n.use, Uo.forEach(function(t) {
                        a[t] = n[t]
            ...
            function rn(t, e, n) {
                oa(e) ? ua(n) ? t.removeAttribute(e) : t.setAttribute(e, e) : ra(e) ? t.setAttribute(e, ua(n) || "false" === n ? "false" : "true") : aa(e) ? ua(n) ? t.removeAttributeNS(ia, sa(e)) : t.setAttributeNS(ia, e, n) : ua(n) ? t.removeAttribute(e) : t.setAttribute(e, n)
            }
            ...
            function yn(t) {
                if (Wi = t, Vi = Wi.length, Ki = Ji = Zi = 0, t.indexOf("[") < 0 || t.lastIndexOf("]") < Vi - 1) return {
                    exp: t,
                    idx: null
                };
                for (; !_n();) Gi = bn(), wn(Gi) ? kn(Gi) : 91 === Gi && xn(Gi);
                return {
                    exp: t.substring(0, Ji),
                    idx: t.substring(Ji + 1, Zi)
                }
            }
            ...
            function Kn(t, e) {
                var n, r = window.getComputedStyle(t),
                    ...
                    l = 0,
                    f = 0;
                return e === Da ? a > 0 && (n = Da, l = a, f = i.length) : e === qa ? c > 0 && (n = qa, l = c, f = u.length) : (l = Math.max(a, c), n = l > 0 ? a > c ? Da : qa : null, f = n ? n === Da ? i.length : u.length : 0), {
                    type: n,
                    timeout: l,
                    propCount: f,
                    hasTransform: n === Da && Va.test(r[Fa + "Property"])
                }
            }
                ...
                if (!n(i) && !r(o._enterCb) && 1 === o.nodeType) {
                    ...
                    if (!A || w || "" === w) {
                        var j = A && d ? d : c,
                            ...
                            R = !1 !== a && !Yo,
                            D = tr(L),
                            q = o._enterCb = k(function() {
                                R && (Wn(o, T), Wn(o, E)), q.cancelled ? (R && Wn(o, j), I && I(o)) : N && N(o), o._enterCb = null
                            });
                        t.data.show || tt(t.data.hook || (t.data.hook = {}), "insert", function() {
                            var e = o.parentNode,
                                n = e && e._pending && e._pending[t.key];
                            n && n.tag === t.tag && n.elm._leaveCb && n.elm._leaveCb(), L && L(o, q)
                        }), P && P(o), R && (Vn(o, j), Vn(o, E), zn(function() {
                            Vn(o, T), Wn(o, j), q.cancelled || D || (Qn(M) ? setTimeout(q, M) : Gn(o, u, q))
                        })), t.data.show && (e && e(), L && L(o, q)), R || D || q()
                    }
                }
            }
            ...
            function Xn(t, e) {
                function o() {
                    $.cancelled || (t.data.show || ((i.parentNode._pending || (i.parentNode._pending = {}))[t.key] = t), h && h(i), _ && (Vn(i, l), Vn(i, d), zn(function() {
                        Vn(i, p), Wn(i, l), $.cancelled || w || (Qn(x) ? setTimeout($, x) : Gn(i, c, $))
                    })), v && v(i, $), _ || w || $())
                }
                var i = t.elm;
                ...
                if (!r(i._leaveCb) && 1 === i.nodeType) {
                    var u = a.css,
                        ...
                        $ = i._leaveCb = k(function() {
                            i.parentNode && i.parentNode._pending && (i.parentNode._pending[t.key] = null), _ && (Wn(i, p), Wn(i, d)), $.cancelled ? (_ && Wn(i, l), g && g(i)) : (e(), m && m(i)), i._leaveCb = null
                        });
                    y ? y(o) : o()
                }
            }
                ...
                return br(t, {
                    ...
                    start: function(t, a, c) {
                        ...
                        if (s || (xr(f), f.pre && (s = !0)), $s(f.tag) && (u = !0), s) kr(f);
                            ...
                            Or(f), Sr(f), Tr(f), $r(f), f.plain = !f.key && !a.length, Cr(f), Pr(f), Lr(f);
            ...
            function Ur(t, e) {
                t && (Ss = tu(e.staticKeys || ""), As = e.isReservedTag || Do, Br(t), zr(t, !1))
            }
            ...
            var oi, ii, ai = function() {
                ...
                ci = function() {
                    ...
                    if ("undefined" != typeof Promise && A(Promise)) {
                        ...
                        e = function() {
                            o.then(t).catch(i), ti && setTimeout(_)
                        }
            ...
            var vi = Object.getOwnPropertyNames(hi),
                ...
                gi = function(t) {
                    if (this.value = t, this.dep = new fi, this.vmCount = 0, C(t, "__ob__", this), Array.isArray(t)) {
                        (Go ? T : P)(t, hi, vi), this.observeArray(t)
                    } else this.walk(t)
                };
            ...
            }, Object.defineProperties(_i.prototype, wi);
            var xi, ki = function() {
                    var t = new _i;
                ...
                Pi = 0,
                Li = function(t, e, n, r) {
                    this.vm = t, t._watchers.push(this), r ? (this.deep = !!r.deep, this.user = !!r.user, this.lazy = !!r.lazy, this.sync = !!r.sync) : this.deep = this.user = this.lazy = this.sync = !1, this.cb = n, this.id = ++Pi, this.active = !0, this.dirty = this.lazy, this.deps = [], this.newDeps = [], this.depIds = new ii, this.newDepIds = new ii, this.expression = "", "function" == typeof e ? this.getter = e : (this.getter = O(e), this.getter || (this.getter = function() {})), this.value = this.lazy ? void 0 : this.get()
                };
                ...
                Ri = {
                    init: function(t, e, n, r) {
                        if (!t.componentInstance || t.componentInstance._isDestroyed) {
                            (t.componentInstance = Jt(t, Ci, n, r)).$mount(e ? t.elm : void 0, e)
                    ...
                    insert: function(t) {
                        ...
                        n._isMounted || (n._isMounted = !0, kt(n, "mounted")), t.data.keepAlive && (e._isMounted ? St(n) : wt(n, !0))
                    },
                    destroy: function(t) {
            ...
            (function(t) {
                t.prototype._init = function(t) {
                    var e = this;
                    e._uid = Ui++;
                    e._isVue = !0, t && t._isComponent ? pe(e, t) : e.$options = B(de(e.constructor), t || {}, e), e._renderProxy = e, e._self = e, gt(e), lt(e), fe(e), kt(e, "beforeCreate"), zt(e), Lt(e), Bt(e), kt(e, "created"), e.$options.el && e.$mount(e.$options.el)
                }
            })(me),
            function(t) {
                var e = {};
            ...
            function(t) {
                t.prototype._update = function(t, e) {
                    ...
                    var r = n.$el,
                        o = n._vnode,
                        i = Ci;
                    Ci = n, n._vnode = t, n.$el = o ? n.__patch__(o, t) : n.__patch__(n.$el, t, e, !1, n.$options._parentElm, n.$options._refElm), Ci = i, r && (r.__vue__ = null), n.$el && (n.$el.__vue__ = n), n.$vnode && n.$parent && n.$vnode === n.$parent._vnode && (n.$parent.$el = n.$el)
            ...
            function(t) {
                t.prototype.$nextTick = function(t) {
                    ...
                    return a instanceof _i || (a = ki()), a.parent = o, a
                }, t.prototype._o = ue, t.prototype._n = f, t.prototype._s = l, t.prototype._l = ne, t.prototype._t = re, t.prototype._q = w, t.prototype._i = x, t.prototype._m = se, t.prototype._f = oe, t.prototype._k = ie, t.prototype._b = ae, t.prototype._v = J, t.prototype._e = ki, t.prototype._u = mt
            }(me);
            ...
            (function(t) {
                ...
                e.get = function() {
                    ...
                    mergeOptions: B,
                    defineReactive: N
                }, t.set = I, t.delete = M, t.nextTick = ci, t.options = Object.create(null), Uo.forEach(function(e) {
                    t.options[e + "s"] = Object.create(null)
                }), t.options._base = t, y(t.options.components, zi), ge(t), ye(t), be(t), xe(t)
            ...
            var za = Ko && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout,
                ...
                Ja = function(t) {
                    ...
                    function l(t, e) {
                        r(t.data.pendingInsert) && e.push.apply(e, t.data.pendingInsert), t.elm = t.componentInstance.$el, v(t) ? (m(t, e), g(t)) : (Ge(t), e.push(t))
                    }
            ...
            var Za = {
                    inserted: function(t, e, n) {
                        if ("select" === n.tag) {
                            ...
                            r(), (Zo || Xo) && setTimeout(r, 0)
                        } else "textarea" !== n.tag && "text" !== t.type && "password" !== t.type || (t._vModifiers = e.modifiers, e.modifiers.lazy || (t.addEventListener("change", ar), Qo || (t.addEventListener("compositionstart", ir), t.addEventListener("compositionend", ar)), Yo && (t.vmodel = !0)))
                    },
                ...
                Ya = {
                    bind: function(t, e, n) {
                        ...
                        r && o && !Yo ? (n.data.show = !0, Yn(n, function() {
                            t.style.display = i
                        })) : t.style.display = r ? i : "none"
                    },
                    update: function(t, e, n) {
                        var r = e.value;
                        r !== e.oldValue && (n = ur(n), n.data && n.data.transition && !Yo ? (n.data.show = !0, r ? Yn(n, function() {
                        ...
                        if (t.length && this.hasMove(t[0].elm, e)) {
                            ...
                            t.forEach(function(t) {
                                if (t.data.moved) {
                                    var n = t.elm,
                                        r = n.style;
                                    Vn(n, e), r.transform = r.WebkitTransform = r.transitionDuration = "", n.addEventListener(Ua, n._moveCb = function t(r) {
                                        r && !/transform$/.test(r.propertyName) || (n.removeEventListener(Ua, t), n._moveCb = null, Wn(n, e))
                                    })
                                }
                            })
                        }
            ...
            me.config.mustUseProp = na, me.config.isReservedTag = da, me.config.isReservedAttr = ta, me.config.getTagNamespace = Pe, me.config.isUnknownElement = Le, y(me.options.directives, Xa), y(me.options.components, rs), me.prototype.__patch__ = Ko ? Ja : _, me.prototype.$mount = function(t, e) {
                return t = t && Ko ? Ne(t) : void 0, yt(this, t, e)
            }, setTimeout(function() {
                Bo.devtools && si && si.emit("init", me)
            }, 0);
        ...
        var d = new a.e.Store({
            ...
            mutations: {
                SET_CONFIG: function(t, e) {
                    ...
                    }, e), "boolean" == typeof t.config.sidebar && (t.showSidebar = t.config.sidebar)
                },
                ...
                TOGGLE_SIDEBAR: function(t, e) {
                    var n = void 0;
                    if (void 0 === e) {
                        n = !u()(t.page.attributes.sidebar, t.showSidebar)
                    } else n = e;
                ...
                jumpToId: function(t, e) {
                    ...
                    r("updateActiveId", e), r("startJumping"), f.a.emit("jump:started", e), n.i(l.a)(e, function() {
                        return setTimeout(function() {
                            r("stopJumping"), f.a.emit("jump:stopped", e)
                        }, 400)
                    })
                },
            ...
            getters: {
                ...
                currentNav: function(t) {
                    var e = t.config.nav,
                        r = t.page.attributes;
                    return Array.isArray(e) ? e : n.i(c.b)(e, "Object") ? r && r.nav ? e[r.nav] : e.default : []
                },
            ...
            var t = r(a.a.mark(function t(e) {
                ...
                return a.a.wrap(function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            if (r = void 0, i = void 0, s = void 0, p = void 0, !0 === e && (e = v), "string" == typeof e ? s = e : "object" === (void 0 === e ? "undefined" : f(e)) && e.source && (s = e.source), !o(s)) {
                                t.next = 20;
                                break
                            }
                            return g && u.a.start(), t.next = 10, fetch(s, {
                                credentials: n.i(l.a)(s)
                            });
                        case 10:
                            if (d = t.sent, g && u.a.done(), 404 !== d.status) {
                                t.next = 14;
                                break
                            }
                        ...
                        case 21:
                            return "object" === (void 0 === e ? "undefined" : f(e)) && (e.markdown ? (r = e.markdown, i = n.i(c.a)(r, y)) : e.html && (i = e.html), e.component && (p = Object.assign({
                                name: _
                            }, e.component, {
                                template: "<div>" + i + "</div>"
                            }))), t.abrupt("return", {
        ...
        t.exports = {
            "custom-toc": "_13JmIB1emdpmGGUjth0wc2_0"
        }
    }, function(t, e, n) {
        "use strict";
        ...
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] HeaderIcons.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(70)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/HeaderNav.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] HeaderNav.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e) {
                ...
                (0, t.registerComponent)("content:start", {
                    ...
                    render: function() {
                        ...
                        if (o) {
                            ...
                            return a && u.push("announcement-" + a), t("div", {
                                class: u,
                                domProps: {
                                    innerHTML: s
                                }
        ...
        function o(t) {
            ...
            return {
                attributes: n.i(i.a)(r) || {},
                body: t.replace(e[0], ""),
                frontmatter: r
            }
        }
        var i = n(33),
            a = "^(\\ufeff?(= yaml =|---)$([\\s\\S]*?)(?:\\2|\\.\\.\\.)$" + ("win32" === n.i({
                env: n.i({
                    NODE_ENV: "production"
                })
            }).platform ? "\\r?" : "") + "(?:\\n)?)",
            ...
            for (var h = 0, m = i.length; h < m; ++h)
                if (d = i[h], !d.match(o)) {
                    if ((a = (e = n.exec(d)) ? e[1].length : 0) > s) {
                        var g = l;
                        l = new r(a), g.addChild(l), u.push(l), f.push(a)
                    } else if (a < s) {
                        for (var y = !1, b = f.length - 1; b >= 0; --b)
                            if (f[b] == a) {
                                l = new r(a), u.push(l), f.push(a), null != u[b].parent && u[b].parent.addChild(l), y = !0;
                                break
                            }
        ...
        function u(t) {
            for (var e = null, n = {}, r = null, o = null, c = null, l = -1, f = [], h = !0, m = 0, g = t.length; m < g; ++m)
                if (-1 == l || l == t[m].level) {
                    f.push(m), l = t[m].level, r = t[m].lines, o = t[m].children, c = null;
                    for (var y = 0, b = r.length; y < b; ++y) {
                        ...
                        if (e = _.match(v.key)) {
                            ...
                            if ("-" == w[0] && (w = w.replace(v.item, ""), h && (h = !1, void 0 === n.length && (n = [])), null != c && n.push(c), c = {}, h = !0), void 0 !== e[2]) {
                                ...
                                if ("&" == x[0]) {
                                    var k = u(o);
                                    null != c ? c[w] = k : n[w] = k, d[x.substr(1)] = k
                                } else if ("|" == x[0]) null != c ? c[w] = s(o.shift()) : n[w] = s(o.shift());
                                else if ("*" == x[0]) {
                                    var $ = x.substr(1),
                                        C = {};
                                ...
                                } else ">" == x[0] ? null != c ? c[w] = a(o.shift()) : n[w] = a(o.shift()) : null != c ? c[w] = i(x) : n[w] = i(x)
                            } else null != c ? c[w] = u(o) : n[w] = u(o)
                        } else {
                            if (_.match(/^-\s*$/)) {
                            ...
                            if (e = _.match(/^-\s*(.*)/)) {
                                null != c ? c.push(i(e[1])) : (h && (h = !1, void 0 === n.length && (n = [])), n.push(i(e[1])));
                                continue
                            }
                        }
                    }
        ...
        e.default = {
            name: "app",
            computed: Object.assign({}, n.i(r.a)(["jumping", "config", "activeId"])),
            mounted: function() {
                var t = this;
                this.detectClick(), this.$watch("activeId", function() {
                    if (t.$store.state.config.syncTocPosition) {
                        ...
                        e && (e.scrollIntoViewIfNeeded ? e.scrollIntoViewIfNeeded() : a()(e, n.i(o.a)(".sidebar"), {
            ...
            methods: Object.assign({}, n.i(r.c)(["jumpToId"]), {
                ...
                fetchResource: function() {
                    ...
                    var e = r(i.a.mark(function t() {
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 2, n.i(a.a)(this.toc, {
                                        progress: !1,
        ...
        e.default = {
            ...
            methods: {
                hintPosition: function(t) {
                    return (this.showNav || o.b) && t === this.currentIcons.length - 1 ? "hint--bottom-left" : "hint--bottom"
                }
            },
            components: {
                SvgIcon: r.a
        ...
        e.default = {
            ...
            computed: Object.assign({}, n.i(r.b)(["currentNav"]), {
                hasComponentsAroundIcons: function() {
                    return c.b.count("icons:start") > 0 || c.b.count("icons:end") > 0
                }
            }),
            components: {
                HeaderNav: i.a,
        ...
        e.default = {
            ...
            computed: Object.assign({}, n.i(r.a)(["config", "showMobileSidebar"])),
            mounted: function() {
                var t = this;
                this.$watch("showMobileSidebar", function() {
                    ...
                    var r = t.$refs.header,
                        o = n.i(s.a)(".sidebar");
                    s.b && r && !o.contains(e.target) && !r.contains(e.target) && t.toggleMobileSidebar(!1)
                })
            },
            methods: Object.assign({}, n.i(r.c)(["toggleMobileSidebar"])),
            components: {
                HeaderIcons: i.a,
                SvgIcon: a.a
            }
        ...
        e.default = {
            ...
            computed: Object.assign({}, n.i(r.a)(["config", "searchKeyword", "searchState"])),
            methods: Object.assign({}, n.i(r.c)(["search", "updateSearchKeyword", "searchReset"]), {
        ...
        var r = n(1);
        e.default = {
            computed: Object.assign({}, n.i(r.a)(["pluginSearch", "searchState"]), n.i(r.a)({
        ...
        var r = n(3),
            o = n(1);
        e.default = {
            methods: Object.assign({}, n.i(o.c)(["toggleSidebar"])),
            components: {
                SvgIcon: r.a
            }
        }
        ...
        e.default = {
            ...
            computed: Object.assign({}, n.i(r.a)(["activeId", "config"]), {
        ...
        e.default = {
            ...
            computed: Object.assign({}, n.i(a.a)(["config"])),
            created: function() {
                this.fetchLanding()
            },
            methods: {
                fetchLanding: function() {
                    ...
                    var e = r(i.a.mark(function t() {
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 2, n.i(s.a)(this.config.landing, {
        ...
        N.a.setOptions({
            ...
            mounted: function() {
                ...
                this.$watch("$route.path", function() {
                    return t.fetchData()
                }), q.a.on("reload", function() {
                    return t.fetchData()
                }), this.scrollSpy()
            },
            computed: Object.assign({}, n.i(A.a)({
                id: function(t) {
                    return t.route.query.id
                }
            }), n.i(A.a)(["config", "page", "loaded", "jumping", "activeId", "pluginSearch", "searchResult", "searchKeyword"]), n.i(A.b)(["documentTitle", "showSidebar", "currentNav", "showToc", "showCustomToc", "currentNavItem"]), {
                currentNavSource: function() {
                    var t = this.$route,
                        ...
                        i = n || r || o;
                    return /^https?:\/\//.test(i) ? i : u()(e.url || ".", i)
                },
                currentIcons: function() {
                    ...
                    var h = void 0;
                    return h = n.i(F.b)(a, "Object") && f ? a[f.icons] || a.default : a.default || a, e.concat(h)
                },
                hasNav: function() {
            ...
            methods: Object.assign({}, n.i(A.c)(["updatePage", "toggleMobileSidebar", "jumpToId", "updateActiveId"]), {
                scrollSpy: function() {
                    var t = this,
                        e = function() {
                    ...
                    this.$refs.contentWrap.addEventListener("scroll", P()(e, 300))
                },
                fetchData: function() {
                    function t() {
                        return e.apply(this, arguments)
                            ...
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    if (E.a.start(), e = [], I.a.heading = function(t, r) {
                                            ...
                                            return u.length > 0 && (a += u.length), 1 !== r && e.push({
                                                level: r,
                                                text: t,
                                                slug: a,
                                                directSlug: i,
                                                index: o
                                            }), "<h" + r + ' id="' + a + '" class="' + (1 === r ? "markdown-heading" : "markdown-heading markdown-toc-heading") + '">\n            ' + (1 === r ? "" : ' <span class="anchor" jump-to-id="' + a + '">' + R.a + "</span>") + "\n            " + t + "\n          </h" + r + ">"
                                        }, r = void 0, !this.currentNavItem || !this.currentNavItem.markdown) {
                                        t.next = 8;
                                        break
                                    }
                                    ...
                                    break;
                                case 8:
                                    return t.next = 10, fetch(this.currentNavSource, {
                                        credentials: n.i(F.a)(this.currentNavSource)
                                    });
                                case 10:
                                    if (o = t.sent, E.a.inc(), 404 !== o.status) {
                                        t.next = 15;
                                        break
                                    }
                                ...
                                case 17:
                                    r = t.sent;
                                case 18:
                                    i = n.i(S.a)(r), N.a.setOptions(Object.assign({}, this.config.marked, {
                                        renderer: I.a,
                                        context: {
                                            path: this.$route.path,
                                            routerMode: this.$router.mode
                                        ...
                                        html: H.c.parse(i.body, N.a),
                                        attributes: i.attributes,
                                        headings: this.handleRelation(e)
                                    }), document.title = this.documentTitle, setTimeout(function() {
                                        E.a.done(), q.a.emit("content:updated", s), s.id ? s.jumpToId(s.id) : s.$refs.contentWrap.scrollTop = 0, s.$refs.sidebar && (s.$refs.sidebar.scrollTop = 0)
                                    });
                                case 23:
                                case "end":
                                    return t.stop()
        ...
        function r(t, e, n) {
            ...
            var p = o.isWindow(e),
                ...
                $ = void 0,
                C = void 0;
            p ? (x = e, C = o.height(x), $ = o.width(x), k = {
                left: o.scrollLeft(x),
                top: o.scrollTop(x)
            }, _ = {
                left: d.left - k.left - c,
                top: d.top - k.top - u
            }, w = {
                left: d.left + v - (k.left + $) + f,
                top: d.top + h - (k.top + C) + l
            }, b = k) : (m = o.offset(e), g = e.clientHeight, y = e.clientWidth, b = {
                left: e.scrollLeft,
                top: e.scrollTop
            }, _ = {
                left: d.left - (m.left + (parseFloat(o.css(e, "borderLeftWidth")) || 0)) - c,
                top: d.top - (m.top + (parseFloat(o.css(e, "borderTopWidth")) || 0)) - u
            }, w = {
                left: d.left + v - (m.left + y + (parseFloat(o.css(e, "borderRightWidth")) || 0)) + f,
                top: d.top + h - (m.top + g + (parseFloat(o.css(e, "borderBottomWidth")) || 0)) + l
            }), _.top < 0 || w.top > 0 ? !0 === a ? o.scrollTop(e, b.top + _.top) : !1 === a ? o.scrollTop(e, b.top + w.top) : _.top < 0 ? o.scrollTop(e, b.top + _.top) : o.scrollTop(e, b.top + w.top) : i || (a = void 0 === a || !!a, a ? o.scrollTop(e, b.top + _.top) : o.scrollTop(e, b.top + w.top)), r && (_.left < 0 || w.left > 0 ? !0 === s ? o.scrollLeft(e, b.left + _.left) : !1 === s ? o.scrollLeft(e, b.left + w.left) : _.left < 0 ? o.scrollLeft(e, b.left + _.left) : o.scrollLeft(e, b.left + w.left) : i || (s = void 0 === s || !!s, s ? o.scrollLeft(e, b.left + _.left) : o.scrollLeft(e, b.left + w.left)))
        }
        var o = n(50);
        t.exports = r
    }, function(t, e, n) {
        ...
        function m(t) {
            var e = void 0,
                n = arguments;
            return 0 !== t.offsetWidth ? e = v.apply(void 0, n) : p(t, N, function() {
                e = v.apply(void 0, n)
            }), e
        }
        ...
        var b = Object.assign || function(t) {
            ...
            S = "px",
            A = void 0;
        "undefined" != typeof window && (A = window.getComputedStyle ? u : c);
        ...
        l(["width", "height"], function(t) {
            ...
            L[t] = function(e, r) {
                ...
                if (e) {
                    var o = A(e);
                    return f(e) && (r += d(e, ["padding", "border"], n, o)), g(e, t, r)
                }
            }
        }), t.exports = b({
    ...
    }, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e, n) {
        (function(e, n) {
            t.exports = n()
        })(0, function() {
            "use strict";
            ...
            return function() {
                ...
                function o(t) {
                    m || (m = t), g = t - m, y = p(g, c, h, v), r(y), g < v ? window.requestAnimationFrame(o) : i()
                }

                function i() {
                    r(c + h), u && d && (u.setAttribute("tabindex", "-1"), u.focus()), "function" == typeof b && b(), m = !1
                }
                    ...
                    for (r = o = $.length, o && $.push(A); r < m;) {
                        ...
                        for (g = r + 1, u - e > N((_ - n) / g) && a("overflow"), n += (u - e) * g, e = u, s = 0; s < m; ++s)
                            if (v = t[s], v < e && ++n > _ && a("overflow"), v == e) {
                                ...
                                $.push(I(p(l, 0))), i = d(n, g, r == o), n = 0, ++r
                            }++n, ++e
                    }
                    return $.join("")
                }
        ...
        "use strict";
        e.decode = e.parse = n(82), e.encode = e.stringify = n(83)
    }, function(t, e) {
        ...
        (function(e) {
            ! function(e) {
                ...
                function l(t, e, n) {
                    ...
                    return function(i, a) {
                        ...
                        for (n.method = i, n.arg = a;;) {
                            ...
                            "throw" === c.type && (r = j, n.method = "throw", n.arg = c.arg)
                        }
                    }
                }
                ...
                a.prototype = N.constructor = s, s.constructor = a, s[k] = a.displayName = "GeneratorFunction", C.isGeneratorFunction = function(t) {
                    ...
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, s) : (t.__proto__ = s, k in t || (t[k] = "GeneratorFunction")), t.prototype = Object.create(N), t
                }, C.awrap = function(t) {
                    return {
                        __await: t
                    }
        ...
        }, n(94), e.setImmediate = setImmediate, e.clearImmediate = clearImmediate
    }, function(t, e, n) {
        window.fetch || (window.fetch = n(21).default || n(21))
    }, function(t, e, n) {
        function r(t) {
        ...
        r.prototype.parse = function(t, e, n) {
            ...
            if (n || f || a.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                var h = "//" === a.substr(0, 2);
                !h || f && b[f] || (a = a.substr(2), this.slashes = !0)
            }
            if (!b[f] && (h || f && !_[f])) {
            ...
            if ($) {
                n.hostname = n.host = E ? "" : k.length ? k.shift() : "";
                var C = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@");
                C && (n.auth = C.shift(), n.host = n.hostname = C.shift())
            }
            return w = w || n.host && k.length, w && !E && k.unshift(""), k.length ? n.pathname = k.join("/") : (n.pathname = null, n.path = null), c.isNull(n.pathname) && c.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = t.auth || n.auth, n.slashes = n.slashes || t.slashes, n.href = n.format(), n
        ...
        function n(t, e) {
            r(e, l, function() {
                s[t].instances.push(this)
            }), r(e, "beforeDestroy", function() {
                var e = s[t].instances;
        ...
        e.install = function(t, n) {
            if (!u) return u = !0, i = t.__esModule ? t.default : t, a = i.version.split(".").map(Number), c = n, i.config._lifecycleHooks.indexOf("init") > -1 && (l = "init"), e.compatible = a[0] >= 2, e.compatible ? void 0 : void console.warn("[HMR] You are using a version of vue-hot-reload-api that is only compatible with Vue.js core ^2.0.0.")
        }, e.createRecord = function(t, e) {
            var r = null;
            "function" == typeof e && (r = e, e = r.options), n(t, e), s[t] = {
                Ctor: i.extend(e),
                instances: []
            }
        }, e.rerender = o(function(t, e) {
            var n = s[t];
            if (!e) return void n.instances.slice().forEach(function(t) {
                t.$forceUpdate()
            });
            "function" == typeof e && (e = e.options), n.Ctor.options.render = e.render, n.Ctor.options.staticRenderFns = e.staticRenderFns, n.instances.slice().forEach(function(t) {
                t.$options.render = e.render, t.$options.staticRenderFns = e.staticRenderFns, t._staticTrees = [], t.$forceUpdate()
            })
        }), e.reload = o(function(t, e) {
            var r = s[t];
            if (e) {
                "function" == typeof e && (e = e.options), n(t, e), a[1] < 2 && (r.Ctor.extendOptions = e);
                var o = r.Ctor.super.extend(e);
                r.Ctor.options = o.options, r.Ctor.cid = o.cid, r.Ctor.prototype = o.prototype, o.release && o.release()
            }
            r.instances.slice().forEach(function(t) {
        ...
        function r(t) {
            o || (n(56), n(57), n(61), n(58), n(60), n(59))
        }
        var o = !1,
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/App.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] App.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        (function(t) {
            function e(t) {
                r || (o.$style = n(18), Object.defineProperty(this, "$style", {
                    get: function() {
                        return o.$style
                    }
                }))
            ...
            i.options.__file = "/Users/egoist/dev/docute/src/components/CustomToc.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
                return "default" !== t && "__" !== t.substr(0, 2)
            }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] CustomToc.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
        }).call(e, n(24)(t))
    }, function(t, e, n) {
        function r(t) {
            o || (n(65), n(66))
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/HomeHeader.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] HomeHeader.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(73)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/MobileHeader.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] MobileHeader.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        ...
        r.options.__file = "/Users/egoist/dev/docute/src/components/NavLink.vue", r.esModule && Object.keys(r.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), r.options.functional && console.error("[vue-loader] NavLink.vue: functional components are not supported with templates, they should use render functions."), t.exports = r.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(67)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/SearchBox.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] SearchBox.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(64)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/SearchResult.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] SearchResult.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(54)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/SidebarToggle.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] SidebarToggle.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(55)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/components/Toc.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] Toc.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || (n(72), n(71))
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/views/404.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] 404.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || n(63)
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/views/Landing.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] Landing.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        function r(t) {
            o || (n(68), n(69))
        }
        ...
        i.options.__file = "/Users/egoist/dev/docute/src/views/Page.vue", i.esModule && Object.keys(i.esModule).some(function(t) {
            return "default" !== t && "__" !== t.substr(0, 2)
        }) && console.error("named exports are not supported in *.vue files."), i.options.functional && console.error("[vue-loader] Page.vue: functional components are not supported with templates, they should use render functions."), t.exports = i.exports
    }, function(t, e, n) {
        t.exports = {
            render: function() {
                var t = this,
            ...
            render: function() {
                ...
                return n("ul", {
                    ...
                    return n("li", {
                        ...
                        class: {
                            "has-children": t.hasChildren(e.index), visible: t.isVisible(e.level, e.parent)
                        },
                        attrs: {
                            "data-level": e.level
                        }
        ...
        function g(t) {
            if (!g.installed) {
                ...
                }), t.component("router-view", jt), t.component("router-link", Rt);
                ...
                render: function(t) {
                    ...
                    if ("a" === this.tag) k.on = x, k.attrs = {
                        ...
                        if ($) {
                            ...
                            ($.data = C({}, $.data)).on = x;
                            ($.data.attrs = C({}, $.data.attrs)).href = s
                        } else k.on = x
                    }
        ...
        var Wt = Object.create(null),
            ...
            Zt = Q(),
            Yt = function(t, e) {
                this.router = t, this.base = it(e), this.current = Nt, this.pending = null, this.ready = !1, this.readyCbs = [], this.readyErrorCbs = [], this.errorCbs = []
            };
        ...
        var Xt = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.go = function(t) {
                    ...
                    this.transitionTo(t, function(t) {
                        nt(_(r.base + t.fullPath)), W(r.router, t, i, !1), e && e(t)
                    }, n)
                    ...
                    var r = this,
                        ...
                        i = o.current;
                    this.transitionTo(t, function(t) {
                        rt(_(r.base + t.fullPath)), W(r.router, t, i, !1), e && e(t)
                    }, n)
            ...
            Qt = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.setupListeners = function() {
                    ...
                    window.addEventListener("hashchange", function() {
                        xt() && t.transitionTo(kt(), function(t) {
                            Ct(t.fullPath)
                        })
                    })
                }, e.prototype.push = function(t, e, n) {
        ...
        ee.prototype.match = function(t, e, n) {
            ...
            return {
                location: r,
                route: o,
                href: St(this.history.base, i, this.mode),
                normalizedTo: r,
                resolved: o
            }
        }, ee.prototype.addRoutes = function(t) {
            this.matcher.addRoutes(t), this.history.current !== Nt && this.history.transitionTo(this.history.getCurrentLocation())
        }, Object.defineProperties(ee.prototype, ne), ee.install = g, ee.version = "2.5.3", Dt && window.Vue && window.Vue.use(ee), e.a = ee
    }, function(t, e) {
        function n(t, e) {
            var r = {
                name: t.name,
        ...
        e.sync = function(t, e, r) {
            ...
            t.watch(function(t) {
                ...
                i = e.fullPath, t.commit("router/ROUTE_CHANGED", {
                    to: e,
                    from: n
                })
            })
